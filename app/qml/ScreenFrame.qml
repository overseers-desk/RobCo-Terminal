...
// The bezel a screen wears when no chassis stands around it: a smooth moulded
// surround, tinted by the screen's own frame colour and lit by the room, with
// no casting, no plate and no bank beside it. The tube came out of the factory
// in this and keeps it wherever it is set down.
ShaderEffect {
    // The frame is opaque plastic whatever the screen behind it does.
    blending: false
