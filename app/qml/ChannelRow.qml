...
Item {
    ...
    // Unlit lamp rows above and below the glyphs, counted together: the band
    // that carries the lamp field out to the window's lips.
    required property int padCellsY
